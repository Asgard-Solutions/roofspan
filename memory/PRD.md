...
- **Remaining (safely DEFER to the resolve-placement scaffold — no pinwheel):** unequal-width L and crossing/through wings (true 3D ridge-height-mismatch framing); dormers seated on a hip-end triangle host; multi-core >2 blocks; penetration auto-placement polish (Stage 6).
