...
// asymmetric hip (unequal pitch) -> deferred to next phase, not forced
...
assert.strictEqual(r.status, "needs_review"); ok("asymmetric hip: needs_review (deferred)");
assert.strictEqual(r.document.vertices.length, 0); ok("asymmetric hip: NO fabricated geometry");
