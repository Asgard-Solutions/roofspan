...
function newEdge() {
  const ref = uid();
  return { ref, _k: ref, edge_type: "eave", ft: "", in: "", length_ft: 0, facet_ref: "" };
}

// Serialize an editable edge into the PUT payload, always carrying its identity ref.
function edgeToBody(e, i) {
  return {
    ref: e.ref || e.id || e._k,
    edge_type: e.edge_type || "eave",
    length_ft: parseFloat(e.length_ft) || 0,
    facet_ref: e.facet_ref || null,
    label: e.label || null,
    notes: e.notes || null,
    sort: i,
  };
