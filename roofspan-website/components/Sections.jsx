    ...
    <section id="sales" className="bg-white py-20" aria-labelledby="sales-h">
      <div className="container-x grid items-center gap-12 lg:grid-cols-2">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <div className="hidden self-end sm:block"><PhoneMock src="/screenshots/mobile-area.webp" alt="RoofSpan Mobile My Area — assigned canvass section on satellite view with property pins" /></div>
        </div>
      </div>
    </section>
  );
