...
const title = "RoofSpan — Roofing Operations Software for Contractors";
const description = "RoofSpan connects your roofing office and field crews — leads, properties, inspections, photos, jobs, and team access — in one operation that runs on your company's own Windows system.";
